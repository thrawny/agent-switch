...
- Repo split (moved here 2026-08-03): these artifacts live in agent-switch — the build home for sidebar, daemon, registry, and verb interface. The throwaway prototypes (`bin/thread-summon|dismiss|settle`) and the niri binds/window rule (`nix/home/linux/niri/default.nix`) live in the **dotfiles** repo and stay there until the real verbs land here.
