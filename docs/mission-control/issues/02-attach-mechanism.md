...
- **Summon-to-me only** (decided 2026-08-03): no "go to the window" sub-verb — cross-area pulls aren't a real workflow (a work thread doesn't get summoned into the dotfiles area), so one verb suffices.
